      ...
      <div className="container">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          {caseStudies.map((study, i) => (
            <div key={i} className="card" style={{ borderLeft: "4px solid var(--color-gold-500)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "16px", marginBottom: "16px" }}>
                <h3 className="h3" style={{ margin: 0 }}>{study.scenario}</h3>
                <span style={{ background: "var(--color-gold-500)", color: "var(--color-navy-900)", padding: "8px 16px", borderRadius: "20px", fontWeight: 600, fontFamily: "var(--font-serif)", fontSize: "14px" }}>
                  {study.settlement}
                </span>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "24px" }}>
                <div>
                  <h4 style={{ fontFamily: "var(--font-serif)", fontSize: "14px", fontWeight: 600, margin: "0 0 8px", color: "var(--color-text-tertiary)" }}>Key Success Factors</h4>
                ...
                <div>
                  <h4 style={{ fontFamily: "var(--font-serif)", fontSize: "14px", fontWeight: 600, margin: "0 0 8px", color: "var(--color-text-tertiary)" }}>Case Timeline</h4>
